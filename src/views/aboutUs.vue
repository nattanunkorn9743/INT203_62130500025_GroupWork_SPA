<template>
     <div class="flex items-center h-auto max-w-4xl mx-auto my-32 lg:h-screen lg:my-0">
    
	<!--Main Col-->
	<div id="profile" class="w-full mx-2 bg-white rounded-lg shadow-2xl opacity-75 lg:w-3/5 lg:rounded-l-lg lg:rounded-r-none lg:mx-0">
		...
		<div class="text-center md:p-6 lg:text-left">
			...
			<p class="flex items-center justify-center pt-4 text-base font-bold lg:justify-start"><svg class="h-4 pr-4 text-green-700 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9 12H1v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6h-8v2H9v-2zm0-1H0V5c0-1.1.9-2 2-2h4V2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1h4a2 2 0 0 1 2 2v6h-9V9H9v2zm3-8V2H8v1h4z"/></svg>The dolls and toys </p>
			<p class="flex items-center justify-center pt-2 text-xs text-gray-600 lg:text-sm lg:justify-start"><svg class="h-4 pr-4 text-green-700 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10 20a10 10 0 1 1 0-20 10 10 0 0 1 0 20zm7.75-8a8.01 8.01 0 0 0 0-4h-3.82a28.81 28.81 0 0 1 0 4h3.82zm-.82 2h-3.22a14.44 14.44 0 0 1-.95 3.51A8.03 8.03 0 0 0 16.93 14zm-8.85-2h3.84a24.61 24.61 0 0 0 0-4H8.08a24.61 24.61 0 0 0 0 4zm.25 2c.41 2.4 1.13 4 1.67 4s1.26-1.6 1.67-4H8.33zm-6.08-2h3.82a28.81 28.81 0 0 1 0-4H2.25a8.01 8.01 0 0 0 0 4zm.82 2a8.03 8.03 0 0 0 4.17 3.51c-.42-.96-.74-2.16-.95-3.51H3.07zm13.86-8a8.03 8.03 0 0 0-4.17-3.51c.42.96.74 2.16.95 3.51h3.22zm-8.6 0h3.34c-.41-2.4-1.13-4-1.67-4S8.74 3.6 8.33 6zM3.07 6h3.22c.2-1.35.53-2.55.95-3.51A8.03 8.03 0 0 0 3.07 6z"/></svg>Company Location-Pathum Wan, Pathum Wan District,Bangkok 10330</p>
			<p class="pt-8 text-sm">Totally optional short description about company,what do we sale and what do you want to buy are here</p>
			...
			<div class="flex flex-wrap items-center justify-between w-4/5 pb-16 mx-auto mt-6 lg:pb-0 lg:w-full">
				...
				<a class="link" href="#" ><svg class="h-6 text-gray-600 fill-current hover:text-green-700" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Unsplash</title><path d="M7.5 6.75V0h9v6.75h-9zm9 3.75H24V24H0V10.5h7.5v6.75h9V10.5z"/></svg></a>
	...
	<div class="w-full lg:w-2/5">
		...
		<img src="https://i.pinimg.com/564x/99/0c/4e/990c4eaba0b8714cb1fc7f21a8fdfc5a.jpg" class="hidden rounded-none shadow-2xl lg:rounded-lg lg:block">
	...
	<!-- Pin to top right corner -->
	  <div class="absolute top-0 right-0 h-12 p-0 w-18">
